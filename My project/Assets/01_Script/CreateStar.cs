...
public class CreateStar : MonoBehaviour
{
    ...
    void Phase2()
    {
        ...
        for (int i = 0; i < count; i++) // 입력된 수(count)만큼 반복합니다. 
        {
            ...
            for (int j = 0; j < count - i; j++) // 각 줄마다 별이 추가될 수 있도록 반복합니다.
            {
                result += "★"; // 별을 추가합니다.
            }
            result += "\n"; // 줄바꿈을 추가합니다. 입력된 수 만큼 반복될 때 줄바꿈을 진행합니다.
    ...
    void Phase3()
    {
        ...
        for (int i = 0; i < count; i++) // 입력된 수(count)만큼 반복합니다. 
        {
            ...
            for (int j = 1; j < count - i; j++) // 각 줄마다 별이 추가될 수 있도록 반복합니다.
            {
                result += "★"; // 별을 추가합니다.
            }
            result += "\n"; // 줄바꿈을 추가합니다. 입력된 수 만큼 반복될 때 줄바꿈을 진행합니다.
    ...
    void Phase4()
    {
        ...
        for (int i = 1; i < count; i++) // 입력된 수(count)만큼 반복합니다. 
        {
            for (int j = 0; j < i; j++) 
            {
                result += "　"; 
    ...
    void Phase5()
    {
        ...
        for (int i = 1; i < count + 1; i++) // 입력된 수(count)만큼 반복합니다. 
        {
            for (int j = 0; j < count - i; j++) // 각 줄마다 별이 추가될 수 있도록 반복합니다.
            {
                result += "　";
            ...
            for (int j = 0; j < 2*i - 1; j++) // 각 줄마다 별이 추가될 수 있도록 반복합니다.
            {
                result += "★"; // 별을 추가합니다.
            }
            result += "\n"; // 줄바꿈을 추가합니다. 입력된 수 만큼 반복될 때 줄바꿈을 진행합니다.
